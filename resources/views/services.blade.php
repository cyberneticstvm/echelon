            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0 border-radius-0 custom-box-shadow-1">
                    <div class="card-body text-center p-4 py-5">
                        ...
                        <p class="custom-font-secondary font-weight-bold text-color-dark text-4 mb-4">100+ Cases</p>
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="card border-0 border-radius-0 custom-box-shadow-1">
                    <div class="card-body text-center p-4 py-5">
                        ...
                        <p class="custom-font-secondary font-weight-bold text-color-dark text-4 mb-4">100+ Protections</p>
